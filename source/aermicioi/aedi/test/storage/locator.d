...
unittest {
    ...
    storage.set(new Wrapper!(MockStruct)(MockStruct(10)), "alien");
    storage.set(new Wrapper!(MockExternObject)(new MockExternObject(10)), "c++alien");
    storage.set(new Wrapper!(MockExternInterface)(new MockExternObject(10)), "c++alienInterface");
